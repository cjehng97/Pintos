...
#define NPGMASK ~(PGMASK)				   /* Retrieve the pointer pointing to the beginning of a page */
...
static inline void * start_of_page (const void *va) {
	return (void *) ((unsigned)va & NPGMASK);
}
